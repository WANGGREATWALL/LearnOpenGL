...
void init(GLFWwindow* window)
{
	...
	renderingProgramCubeMap = Utils::createShaderProgram("shaderSkybox.vs", "shaderSkybox.fs");
	...
	skyboxTexture = Utils::loadCubemapByStbImage(skybox);
...
void display(GLFWwindow* window, double currentTime)
{
	...
	// auto rMat = glm::rotate(glm::mat4(1.0f), (float)currentTime, glm::vec3(0.0, 1.0, 0.0));
	// vMat *= rMat;
	...
	rotAmt = (float)(currentTime * 0.5f);
	mMat = glm::translate(glm::mat4(1.0f), glm::vec3(torLocX, torLocY, torLocZ));
	mMat = glm::rotate(mMat, rotAmt, glm::vec3(1.0f, 1.0f, 0.0f));
