...
{
    renderingProgram1 = Utils::createShaderProgram("shader1.vs", "shader1.fs");
	renderingProgram2 = Utils::createShaderProgram("shader2.vs", "shader2.fs");
