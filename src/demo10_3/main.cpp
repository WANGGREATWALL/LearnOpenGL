...
void init(GLFWwindow* window)
{
	...
	moonTexture = Utils::loadTextureByStbImage("moon.jpg");
	moonNormalMap = Utils::loadTextureByStbImage("moonNORMAL.jpg");
}
...
void display(GLFWwindow* window, double currentTime)
{
	...
	glUniform1i(glGetUniformLocation(renderingProgram, "s"), 1);
	glUniform1i(glGetUniformLocation(renderingProgram, "normMap"), 0);
