...
void init(GLFWwindow* window)
{
	...
	gndLocX = 0.0f; gndLocY = -0.2f; gndLocZ = 0.0f;
	...
	heightTexture = Utils::loadTextureByStbImage("heightTexture.jpg");
	heightMap = Utils::loadTextureByStbImage("height.jpg");
}
...
void display(GLFWwindow* window, double currentTime)
{
	...
	glUniform1i(glGetUniformLocation(renderingProgram, "t"), 0);
	glUniform1i(glGetUniformLocation(renderingProgram, "h"), 1);
