...
void init(GLFWwindow* window)
{
	...
	brickTexture = Utils::loadTextureByStbImage("castleroof.jpg"); // castleroof
	skyboxTexture = Utils::loadTextureByStbImage("castleroof.jpg"); // alienWorldSkyBox
